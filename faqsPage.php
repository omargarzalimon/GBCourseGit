...
div.midiv1{
 ...
 <!-- Menu -->
  ...
  <div class="row">
    <div class="col-sm-12"><img class="card-img " src="img/header_faqs.png" alt="Card image">
    </div>
  </div>
   ...
   <div class="row">
  <div class="col-3 border-right" style="height:70%">
    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
      <br>
      <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">¿How do I get points?</a>
      <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">¿What are the beercoins?</a>
      <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">¿Are there personalized advice?</a>
      <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">¿How do I recover my password?</a>
    </div>
  </div>
  <div class="col-7">
   ...
   <footer class=" mt-3">
  <div class="container-fluid mx-0 align-items-center">
    <div class="row text-center">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <img src="img/footer.jpg" class="imgMountains" alt="Image">
      </div>
    ...
    <div class="row linksRow">
      ...
      <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-center">
        <span class="copyright">&#x24B8; 2018 Anheuser-Busch InBev All rights reserved.</span>
      </div>
    </div>
  </div>
</footer>
